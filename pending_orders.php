<?php
include ("./get_pending_orders.php")?>
<!DOCTYPE html>
<html lang="en">
            ...
            <!-- Main Page -->
                    ...
                    while($orders = mysqli_fetch_assoc($fetch_orders)){
                        ...
                        <div class=\"card-body text-center\" style=\"border-width: 0px !important;background: #eaeaea; border-radius: 15px; margin-bottom: 10px;\">
                            ...
                            <form action=\"complete_order.php\" method=\"POST\" class=\"rForm\">
                            <input type=\"number\" value=\"".$orders["id"]."\" name =\"orderID\" id=\"order\" hidden>
                            <input class=\"btn btn-secondary\" type =\"submit\" style=\"min-width: 100%;margin-bottom: 12px;\" value=\"Complete Order\">
                            </form>
                            <form action=\"delete_order.php\" method=\"POST\" class=\"rForm\">
                            <input type=\"number\" value=\"".$orders["id"]."\" name =\"orderID\" id=\"order\" hidden>
                            <input class=\"btn btn-secondary\" type =\"submit\" style=\"min-width: 100%;margin-bottom: 12px;\" value=\"Delete Order\">
                            </form>
